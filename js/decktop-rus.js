...
const arrayDataOfService = [
    {
        ...
        prices: [
            {
                nameOfServise: "Дизайн сайтов",
                cost: 500
            },

            {
                nameOfServise: "Дизайн мобильных приложений",
                cost: 700
            },

            {
                nameOfServise: "Логотип и брендинг",
                cost: 300
            },

            {
                nameOfServise: "Графический дизайн",
                cost: 100
            },

            {
                nameOfServise: "Дизайн упаковки",
                cost: 400
            },

            {
                nameOfServise: "Дизайн для печати",
                cost: 150
            },

            {
                nameOfServise: "UI/UX дизайн",
                cost: 150
            },
...

    {
        ...
        prices: [
            {
                nameOfServise: "Дизайн лендинга",
                cost: 300
            },

            {
                nameOfServise: "Индивидуальный дизайн сайта",
                cost: 700
            },

            {
                nameOfServise: "Разработка интернет-магазина",
                cost: 1200
            },

            {
                nameOfServise: "Настройка сайта на WordPress",
                cost: 400
            },

            {
                nameOfServise: "Редизайн/модернизация сайта",
                cost: 600
            },

            {
                nameOfServise: "Одностраничное веб-приложение",
                cost: 900
            },

            {
                nameOfServise: "Разработка SEO-оптимизированного сайта",
                cost: 800
            },
...

    {
        ...
        prices: [
            {
                nameOfServise: "Рекламное видео для продукта/услуги",
                cost: 500
            },

            {
                nameOfServise: "Брендовое видео (до 3 минут)",
                cost: 1000
            },

            {
                nameOfServise: "Видеоконтент для социальных сетей",
                cost: 300
            },

            {
                nameOfServise: "Видео с мероприятий/конференций",
                cost: 800
            },

            {
                nameOfServise: "Обучающее корпоративное видео",
                cost: 600
            },

            {
                nameOfServise: "Анимационное объясняющее видео",
                cost: 1200
            },

            {
                nameOfServise: "Производство музыкального клипа",
                cost: 1500
            },
...

    {
        ...
        prices: [
            {
                nameOfServise: "Написание контента и копирайтинг",
                cost: 300
            },

            {
                nameOfServise: "Техническая поддержка сайтов",
                cost: 400
            },

            {
                nameOfServise: "Разработка стратегии контента",
                cost: 500
            },

            {
                nameOfServise: "Обслуживание и обновление сайтов",
                cost: 350
            },

            {
                nameOfServise: "SEO-оптимизация контента",
                cost: 450
            },

            {
                nameOfServise: "Управление блогом",
                cost: 300
            },

            {
                nameOfServise: "Поддержка клиентов через онлайн-чат",
                cost: 600
            },
...

    {
        ...
        prices: [
            {
                nameOfServise: "Разработка стратегии для социальных сетей",
                cost: 400
            },

            {
                nameOfServise: "Создание и управление контентом",
                cost: 500
            },

            {
                nameOfServise: "Рекламные кампании в социальных сетях",
                cost: 600
            },

            {
                nameOfServise: "Маркетинг через инфлюенсеров",
                cost: 700
            },

            {
                nameOfServise: "Управление сообществом",
                cost: 350
            },

            {
                nameOfServise: "Создание аккаунтов в социальных сетях",
                cost: 300
            },

            {
                nameOfServise: "Аналитика социальных сетей",
                cost: 200
            },
...

    {
        ...
        prices: [
            {
                nameOfServise: "Интеграция платёжных систем",
                cost: 500
            },

            {
                nameOfServise: "Настройка платёжной системы магазина",
                cost: 600
            },

            {
                nameOfServise: "Настройка системы подписки",
                cost: 700
            },

            {
                nameOfServise: "Конфигурация безопасности платёжных систем",
                cost: 450
            },

            {
                nameOfServise: "Тестирование платёжных систем",
                cost: 400
            },

            {
                nameOfServise: "Настройка многовалютных платёжных систем",
                cost: 550
            },

            {
                nameOfServise: "Оптимизация платёжных систем для скорости",
                cost: 600
            },
...
const reviews = [
    {
        top: {
            title: "Дмитрий Малюкин",
            upperText: "Мы обратились к команде Ikigai Creative с просьбой обновить фирменный стиль нашего бренда. Время доказало успех внедренных ими инноваций. Мы с моими коллегами быстро решили продолжить долгосрочное сотрудничество, которое продолжается и по сей день.",
            lowerText: "Хочу порекомендовать эту организацию за ее качественную и добросовестную работу."
        },

        bottom: {
            title: "Михаил Потапенко",
            upperText: "Наша компания энтузиастов мотоспорта хотела продвигать движение в Москве. Мы обратились  за дизайном, разработкой и продвижением веб-сайта. Компания отнеслась к проекту очень серьезно и быстро создали не только отличный макет, но и сам веб-сайт! Ikigai также помогал нам создавать контент для наших групп — писать посты, снимать видео! На нас, клиентов, было делигированно никаких задач — они обо всем позаботились.",
            lowerText: "Мое восхищение и уважение."
        }
    },

    {
        top: {
            title: "Диана Белоусова",
            upperText: "Когда моя команда решила обновить сайт для нашего волонтёрского проекта, я не ожидала, что всё получится так здорово! Команда отлично поняла нашу идею и предложила несколько потрясающих решений. Всё было сделано быстро и с вниманием к каждой детали. Теперь наш сайт не только работает, но и вдохновляет больше людей присоединяться.",
            lowerText: "Рекомендую их как надёжных партнёров!"
        },

        bottom: {
            title: "Андрей Скугаров",
            upperText: "Как человек, который умеет ценить хорошие вещи в жизни, я не ожидал, что наш проект получится настолько успешным. Я обратился к ним для создания видео, и они не просто оправдали мои ожидания — они их превзошли. Видео идеально отразило суть нашего бренда, каждая деталь была на своём месте. Они не просто сняли и смонтировали — они воплотили нашу идею в жизнь так, как я и не мог представить.",
            lowerText: "Респект этой команде за отличную работу!"
        }
    },

    {
        top: {
            title: "София Поминова",
            upperText: "Когда количество международных заказов начало расти, я поняла, что мне нужно более удобное и надежное решение для управления платежами. Обратившись к этой команде, я была приятно удивлена — они быстро настроили безопасную и простую в использовании платежную систему, которая идеально подошла для моих нужд. ",
            lowerText: "Они точно знают толк в этом деле!"
        },

        bottom: {
            title: "Yulia Biryukova",
            upperText: "Как танцовщица, всегда стремящаяся быть на виду, я не ожидала, что моё продвижение в соцсетях принесёт такие результаты. Обратившись к этой команде, я сразу поняла, что сделала правильный выбор. Они не просто подошли к моему стилю с вниманием, но и предложили идеи, которые значительно улучшили моё онлайн-присутствие. Мой контент стал ярче, а вовлеченность и интерес к моей работе возросли.",
            lowerText: "Огромное спасибо за помощь в продвижении!"
        }
    }
]