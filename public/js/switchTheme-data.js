const themeWrapper = {
    ...
    "mh-navigation-block-night-mode-text": {
        styles: {
            light: {
                color: "var(--ltText)",
                background: ""
    ...
    "mh-navigation-block-language-text": {
        styles: {
            light: {
                color: "var(--ltText)",
                background: ""
    ...
    "mh-four-section-button-consultation": {
        styles: {
            light: {
                color: "",
                background: "var(--dtSeparationLine)"
    ...
    "mh-four-section-button-question": {
        styles: {
            light: {
                color: "",
                background: "var(--dtSeparationLine)"
    ...
    "mh-four-section-others-services-right-line": {
        styles: {
            light: {
                color: "",
                background: "var(--dtSeparationLine)"
    ...
    "mh-four-section-others-services-left-line": {
        styles: {
            light: {
                color: "",
                background: "var(--dtSeparationLine)"
    ...
    "mh-six-section-top-review-name": {
        styles: {
            light: {
                color: "var(--ltText)",
                background: ""
    ...
    "mh-six-section-top-review-wrapper-text-0": {
        styles: {
            light: {
                color: "var(--ltText)",
                background: ""
    ...
    "mh-six-section-top-review-wrapper-text-1": {
        styles: {
            light: {
                color: "var(--ltText)",
                background: ""
    ...
    "mh-six-section-bottom-review-name": {
        styles: {
            light: {
                color: "var(--ltText)",
                background: ""
    ...
    "mh-six-section-bottom-review-wrapper-text-0": {
        styles: {
            light: {
                color: "var(--ltText)",
                background: ""
    ...
    "mh-six-section-bottom-review-wrapper-text-1": {
        styles: {
            light: {
                color: "var(--ltText)",
                background: ""
    ...
    "mh-six-section-top-review-line": {
        styles: {
            light: {
                color: "",
    ...
    "mh-six-section-bottom-review-line": {
        styles: {
            light: {
                color: "",
                background: "linear-gradient(180deg, #2e2e2e00 0%, #2e2e2e5e 20.36%, #2e2e2e00 100%)"
    ...
    "central-text-first-section-down": {
        styles: {
            light: {
                color: "var(--ltText)",
                background: ``
    ...
    "language-button-first-section-choice-eng-text": {
        styles: {
            light: {
                color: "var(--ltText)",
                background: ``
    ...
    "language-button-first-section-choice-rus-text": {
        styles: {
            light: {
                color: "var(--ltText)",
                background: ``
    ...
    "theme-button-first-section-choice-light-text": {
        styles: {
            light: {
                color: "var(--ltText)",
                background: ``
    ...
    "theme-button-first-section-choice-dark-text": {
        styles: {
            light: {
                color: "var(--ltText)",
                background: ``
    ...
    "navigation-button-first-section": {
        styles: {
            light: {
                color: "var(--ltText)",
                background: ``
    ...
    "mv-chosen-course-wrapper-block": {
        styles: {
            light: {
                color: "",
                background: `var(--dtText)`
    ...
    "mv-chosen-course-title": {
        styles: {
            ...
            dark: {
                color: "var(--ltSeparationLine)",
                background: ``
            }
        }
    },

    "mv-chosen-course-left-line": {
        styles: {
            light: {
                color: "",
                background: `var(--dtSeparationLine)`
    ...
    "mv-chosen-course-name-of-course": {
        styles: {
            light: {
                color: "var(--ltText)",
                background: ``
    ...
    "mv-chosen-course-name-of-service": {
        styles: {
            light: {
                color: "var(--ltText)",
                background: ``
