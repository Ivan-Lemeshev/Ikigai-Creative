const arrayPriceList = [
    {
        ...
        description: {
            ...
            rus: [
                ...
                "Но мы не останавливаемся на этом. Мы создаём не просто логотипы, а целостную визуальную идентичность для вашего бренда. Полноценная стратегия брендинга — вот что отличает успешные компании, и мы готовы помочь вам стать одной из них."
            ]
        }
    },
