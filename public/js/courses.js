const coursesData = [
    {
        ...
        whatNeed: {
            ...
            whatNeedText: {
                rus: ["Этот курс предназначен для начинающих и не требует большого опыта. Вам понадобятся только базовые навыки, которые будут полезны в процессе обучения.",
                    ...
                    "Стремление развиваться и осваивать новое — ключевой аспект успешного обучения. Важно быть готовым к трудностям и задавать вопросы",
        ...
        descriptionMobile: {
            ...
            rus: ["Хотите ворваться в мир технологий и создавать современные веб-приложения? Наш курс веб-разработки проведет вас от новичка до опытного разработчика. Вы освоите HTML, CSS, JavaScript и современные фреймворки для создания адаптивных и интерактивных сайтов.",
                "Помимо навыков фронтенда, вы погрузитесь в бэкенд-разработку, научитесь работать с базами данных, API и серверным программированием. Практические проекты и эксперты-наставники помогут вам получить реальный опыт и создать сильное портфолио.",
                "Независимо от того, начинаете ли вы новую карьеру или запускаете собственные проекты, этот курс даст вам уверенность и знания, необходимые для успешной работы веб-разработчиком."]
        },
    ...
    },
    {
        ...
        planOfLessons: {
            rus: [
                ...
                {
                    duration: "2 недели",
                    title: "Работа с локальными репозиториями: коммиты/ветки"
                },
                {
                    duration: "1 неделя",
    ...
    <path d="M30.2021 91.6152L28.0352 95.2684V100H71.9686V95.2684L69.798 91.6152H30.2021Z" fill="var(--svgColor)" />
        ...
        descriptionMobile: {
            ...
            rus: [
                ...
                "После прохождения курса вы получите практический опыт игры в шахматы через реальные ситуации и тренировочные задачи."
            ]
        }
    },
    {
        ...
        descriptionMobile: {
            ...
            rus: [
                "В этом курсе вы изучите React — популярную JavaScript библиотеку, используемую разработчиками по всему миру. Вы научитесь создавать переиспользуемые компоненты, эффективно управлять состоянием и разрабатывать адаптивные пользовательские интерфейсы.",
                ...
                "После прохождения курса вы получите практический опыт разработки масштабируемых приложений с использованием React."
            ]
        }
    },
    {
        ...
        planOfLessons: {
            rus: [
                {
                    duration: "2 недели",
                    title: "Основы Python: переменные, данные, операторы"
                },
                {
                    duration: "3 недели",
        ...
        descriptionMobile: {
            ...
            rus: [
                "Этот курс познакомит вас с Python — одним из самых универсальных и доступных языков, используемых разработчиками по всему миру. Вы изучите основы синтаксиса, типы данных и управляющие конструкции, чтобы заложить прочный фундамент.",
                "Начнем с простых скриптов: работа с переменными, циклами, функциями и базовыми операциями. Затем перейдем к продвинутым темам, объектно-ориентированное программирование, использование библиотек и автоматизация задач с помощью мощного инструментария Python.",
                "После завершения курса вы получите практический опыт создания проектов, решающих реальные задачи."
            ]
        }
    },
    {
        ...
        descriptionMobile: {
            ...
            rus: [
                "Этот курс познакомит вас с Aiogram — современным асинхронным фреймворком для разработки ботов на Python. Вы узнаете, как настроить бота, обрабатывать команды и эффективно реагировать на сообщения пользователей.",
                "Начнем с основ: настройка бота, обработка сообщений и создание простых команд. Затем перейдем к продвинутым темам, создание инлайн-клавиатур, управление состоянием, интеграция webhook и работа с внешними API для расширения функционала ботов.",
                "После прохождения курса вы получите практический опыт создания, развертывания и управления полноценными Telegram-ботами."
            ]
        }
    },
    {
        ...
        planOfLessons: {
            rus: [
                ...
                {
                    duration: "2 недели",
                    title: "Построение долгосрочных отношений"
                }
            ],
            eng: [
                {
        ...
        descriptionMobile: {
            ...
            rus: [
                "Этот курс по продажам даст вам проверенные стратегии и техники для успешной работы на всех этапах процесса продаж. Вы изучите методы убеждения, выявления потребностей клиентов и создания прочного доверия с ними.",
                "Начнем с основ: изучения психологии покупателя, развития эффективных коммуникативных навыков и искусства переговоров. Затем перейдем к продвинутым темам, работа с возражениями, техники закрытия сделок и управление отношениями с клиентами после продажи для обеспечения повторных сделок.",
                "После прохождения курса вы получите практический опыт управления воронкой продаж и уверенно справитесь с любыми возражениями."
            ]
        }
    },
    {
        ...
        descriptionMobile: {
            ...
            rus: [
                "В этом курсе вы изучите основы нутрициологии — область, играющую ключевую роль для поддержания здоровья и высокой работоспособности. Вы научитесь балансировать макро- и микронутриенты, читать этикетки и составлять рацион, который будет заряжать вас энергией.",
                ...
                "После прохождения курса вы получите практический опыт в составлении сбалансированного рациона и разработке эффективных планов питания."
            ]
        }
    },
    {
        ...
        planOfLessons: {
            rus: [
                ...
                {
                    duration: "2 недели",
                    title: "Работа с базами данных: таблицы, галереи"
                },
                {
                    duration: "2 недели",
                ...
                {
                    duration: "1 неделя",
                    title: "Командное пространство и совместная работа"
                },
                {
                    duration: "2 недели",
                    title: "Кастомизация рабочего процесса"
                }
            ],
            eng: [
                {
        ...
        descriptionMobile: {
            ...
            rus: [
                "Этот курс познакомит вас с Notion — универсальным инструментом, объединяющим заметки, задачи, базы данных и многое другое. Вы научитесь использовать его гибкость для управления как личными, так и профессиональными процессами.",
                "Изучение интерфейса Notion, создание заметок и простых баз данных, использование шаблонов для быстрого старта. Создание взаимосвязанных баз данных, автоматизация с помощью интеграций и настройка рабочего пространства под ваши нужды.",
                "После прохождения курса вы получите практический опыт в создании надежной системы для организации задач, проектов и идей в Notion. Владение Notion преобразит ваш подход к планированию и выполнению работы."
            ]
        }
    }
